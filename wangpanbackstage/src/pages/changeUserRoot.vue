...
<div class="main bgf7f8f9">
    <div class="bgfff h-con">
        <div class="pt44 pl68 fsize14 col333">
            ...
            <p class="fsize24 f-pf2 mt30 pl40 fweight600">修改用户权限<span class="fsize16 ml5">({{name}})</span></p>
            
        </div>
        <div class="pl108 pr68 pb20 col333 fsize14 bt-eaebef">
            <!-- <div class="flex-end mt26">
                <el-checkbox class="col333" :value="choose_all" @change="chooseAll">全选</el-checkbox>
            </div> -->
            <div class="flex-end mt26">
                <p class="mr48">查看权限</p>
                <p>下载权限</p>
...
export default {
    ...
    methods:{
        ...
        getRootList(){
            this.$fetch({
                url:'admin/admin_user/account_purview',
                data:{
                    dirId:0,
                    id:this.id
                }
        ...
        Confirm(){
            ...
            // return;
            this.$fetch({
                url:'admin/admin_user/edit_account_purview',
                type:'post',
                data
            }).then(res=>{
                if(res.data.returnCode=='0000'){
